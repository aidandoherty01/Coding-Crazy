...
const uri = 'mongodb+srv://notsinned:Password@cluster0.tfek7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
export async function addPlayer(dbName = _dbName, collectionName = _collectionName, id, loc, x, y, numAPlusses) {
...
export async function updatePlayer(dbName = _dbName, collectionName = _collectionName, id, loc, x, y, numAPlusses) {
