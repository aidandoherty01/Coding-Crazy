...
const _jsonFilePath = '../data/export_to_mongo.json'; // file being read from

async function exportJsonToMongo(dbName = _dbName, collectionName = _collectionName, jsonFilePath = _jsonFilePath) {
